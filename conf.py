...
BLOG_AUTHOR = "Alvar, Vlad y todos los que lo habiten"  # (translatable)
BLOG_TITLE = "Recetario Ñoño"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://alvarmaciel.github.io/recetario/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://alvarmaciel.github.io/recetario/"
BLOG_EMAIL = "alvarmaciel@gmail.com"
BLOG_DESCRIPTION = "Este es el sitio del repositorio de recetas"  # (translatable)
